...
function FlipReader({ pages }: { pages: ChapterPage[] }) {
  ...
  return (
    <div className="relative h-full w-full [perspective:1400px]">
      ...
      <button
        className="sf-clickable absolute left-3 top-1/2 z-30 grid h-11 w-11 -translate-y-1/2 place-items-center rounded-full border border-white/10 bg-black/45 text-white shadow-2xl backdrop-blur-xl disabled:cursor-not-allowed disabled:opacity-35"
      ...
      <button
        className="sf-clickable absolute right-3 top-1/2 z-30 grid h-11 w-11 -translate-y-1/2 place-items-center rounded-full border border-white/10 bg-black/45 text-white shadow-2xl backdrop-blur-xl disabled:cursor-not-allowed disabled:opacity-35"
