  ...
  return (
    ...
    >
      <Link
        ...
        className={cn(
          "sf-comic-card group relative block w-full sm:w-[170px] min-w-[140px] overflow-hidden rounded-2xl border border-white/10 bg-card transition-all duration-300 hover:border-primary/45 hover:bg-white/7 hover:shadow-[0_12px_32px_rgba(255,51,102,0.15)]"
        )}
      >
